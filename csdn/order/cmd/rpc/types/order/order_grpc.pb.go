...
func (c *orderClient) OrderGet(ctx context.Context, in *OrderGetRequest, opts ...grpc.CallOption) (*OrderGetResponse, error) {
	out := new(OrderGetResponse)
	err := c.cc.Invoke(ctx, "/order.Order/OrderGet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) OrderDesc(ctx context.Context, in *OrderDescRequest, opts ...grpc.CallOption) (*OrderDescResponse, error) {
	out := new(OrderDescResponse)
	err := c.cc.Invoke(ctx, "/order.Order/OrderDesc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) OrderUpdate(ctx context.Context, in *OrderUpdateRequest, opts ...grpc.CallOption) (*OrderUpdateResponse, error) {
	out := new(OrderUpdateResponse)
	err := c.cc.Invoke(ctx, "/order.Order/OrderUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderServer) OrderGet(context.Context, *OrderGetRequest) (*OrderGetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderGet not implemented")
}
func (UnimplementedOrderServer) OrderDesc(context.Context, *OrderDescRequest) (*OrderDescResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderDesc not implemented")
}
...
func _Order_OrderGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).OrderGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.Order/OrderGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).OrderGet(ctx, req.(*OrderGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Order_OrderDesc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderDescRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).OrderDesc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.Order/OrderDesc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).OrderDesc(ctx, req.(*OrderDescRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Order_OrderUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/order.Order/OrderUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).OrderUpdate(ctx, req.(*OrderUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "OrderGet",
			Handler:    _Order_OrderGet_Handler,
		},
		{
			MethodName: "OrderDesc",
			Handler:    _Order_OrderDesc_Handler,
		},
		{
