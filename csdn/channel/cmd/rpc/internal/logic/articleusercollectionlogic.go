...
func (l *ArticleUserCollectionLogic) ArticleUserCollection(in *channel.ArticleUserCollectionRequest) (*channel.ArticleUserCollectionResponse, error) {
	...
	return &channel.ArticleUserCollectionResponse{Articles: datas}, nil
}
