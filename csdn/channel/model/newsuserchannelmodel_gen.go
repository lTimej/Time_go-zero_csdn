...
type (
	newsUserChannelModel interface {
		...
		FindAllByUserId(ctx context.Context, rowBuilder squirrel.SelectBuilder, user_id string, orderBy string) ([]*UserChannel, error)
		FindOneByUserIdChannelId(ctx context.Context, userId string, channelId int64) (*NewsUserChannel, error)
...
func (m *defaultNewsUserChannelModel) FindAllByUserId(ctx context.Context, rowBuilder squirrel.SelectBuilder, user_id string, orderBy string) ([]*UserChannel, error) {
	if orderBy == "" {
