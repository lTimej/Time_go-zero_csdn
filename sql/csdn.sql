...
###
add by wangzq
ALTER TABLE news_article_basic
    ADD COLUMN update_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间';
ALTER TABLE news_article_basic
    ADD COLUMN reject_reason varchar(200) COMMENT '驳回原因';
ALTER TABLE news_article_basic MODIFY cover json COMMENT '封面';

ALTER TABLE user_basic
    ADD COLUMN account varchar(20) COMMENT '账号';
ALTER TABLE user_basic
    ADD COLUMN email varchar(20) COMMENT '邮箱';
ALTER TABLE user_basic
    ADD COLUMN status tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态，是否冻结';
ALTER TABLE user_basic modify COLUMN password varchar (93) COMMENT '密码';

ALTER TABLE user_profile
    ADD COLUMN area varchar(20) COMMENT '地区';
ALTER TABLE user_profile
    ADD COLUMN company varchar(20) COMMENT '公司';
ALTER TABLE user_profile
    ADD COLUMN career varchar(20) COMMENT '职业';
ALTER TABLE user_profile
    ADD COLUMN tag varchar(20) COMMENT '标签';
